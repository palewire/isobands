...
* GDAL **3.10.2 through 3.12.x** is supported at runtime. Install matching
  system GDAL development files before installing the Python package; pip alone
  cannot provide the system library.
